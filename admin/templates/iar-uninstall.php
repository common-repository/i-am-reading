<div class="wrap form">
	...
	<?php else: ?>
		...
		<?php $deactivate_url = html_entity_decode(wp_nonce_url('plugins.php?action=deactivate&plugin=i-am-reading/i-am-reading.php&plugin_status=all&paged=1', 'deactivate-plugin_i-am-reading/i-am-reading.php')); ?>
