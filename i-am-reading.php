<?php
/*
Plugin Name: I am reading
Plugin URI:  http://www.i-am-reading.info/
...
Version:     1.0.0
Author:      Dominik Hanke / r0ny /shyam
Author URI:  http://www.i-am-reading.info

--------------------------------------------------------------------------
Copyright 2009  Dominik Hanke, Regina Struminski (e-mail: support@i-am-reading.info)
...
function iar_admin_scripts() {
	...
	wp_enqueue_script('iar_boxover', plugins_url($path = 'i-am-reading/admin/js/boxover.js'));
	wp_enqueue_script('iar_settings', plugins_url($path = 'i-am-reading/admin/js/config.js'));
...
function iar_admin_styles() {
	...
	wp_enqueue_style('iar_admin_css', plugins_url($path = 'i-am-reading/admin/admin.css'));
