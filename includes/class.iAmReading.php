 ...
 * @link       http://www.i-am-reading.info/
 *
...
class iAmReading {
	...
	public function __construct() {
		...
		$this->plugin_dir = WP_PLUGIN_DIR . '/i-am-reading';
	}
...
/**
	...
	/**
	 * Get all themes out of the theme directory ('i-am-reading/themes/')
	...
	public function getThemes() {
		...
		// read theme files in i-am-reading/themes directory
